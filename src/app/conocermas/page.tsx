    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 min-h-screen">
        ...
        <div className="flex justify-center mb-16">
          <div className="grid grid-cols-2 gap-4 sm:gap-8 max-w-md sm:max-w-4xl w-full">
            {/* Logo CCU */}
            <div className="relative group">
              ...
              <div className="relative bg-white p-4 sm:p-8 border border-gray-200 group-hover:border-[#2166b0] transition-all duration-300 hover:shadow-xl rounded-lg h-full flex items-center justify-center">
                <div className="w-full max-w-[120px] sm:max-w-[250px] md:max-w-[300px] mx-auto">
                  <img
                    src="assets/CCU.png"
                    alt="CCU Logo"
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-4 sm:p-8 border border-gray-200 group-hover:border-[#76c043] transition-all duration-300 hover:shadow-xl rounded-lg h-full flex items-center justify-center">
                <div className="w-full max-w-[120px] sm:max-w-[250px] md:max-w-[300px] mx-auto">
                  <img
        ...
        <div className="mt-12">
          <button
            ...
            className="px-8 py-3 bg-[#2166b0] text-white hover:bg-[#1a5490] transition-all duración-300 text-sm font-medium transform hover:scale-105 hover:shadow-lg rounded"
          >
