...
const productos = () => {
    ...
    const categories = [
        {
            name: 'CERVEZAS',
            brands: brandLogos.filter(b => ['Norte', 'Heineken', 'Imperial', 'Salta', 'Miller', 'Schneider', 'Amstel', 'Salta Cautiva', 'Iguana', 'Basteiner', 'Gelish', 'Blue Moon'].includes(b.name)),
            color: '#2166b0'
        },
        {
        ...
        {
            name: 'VINOS',
            brands: brandLogos.filter(b => ['Colón', 'La Celia', 'Graffigna', 'Bodegas Colon', '0-61'].includes(b.name)),
            color: '#2166b0'
        },
        {
            name: 'SIDRAS',
